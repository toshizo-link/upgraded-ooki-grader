...
$expectedArchiveSha256 = '28a7b0ef33c61a400c279b2d42b3af533cb734b0081cbd9f27858f5a0939e821'
...
if ([string] $installation.version -eq '0.9.14') {
    Write-Host 'Ooki Grader is already at version 0.9.14.'
