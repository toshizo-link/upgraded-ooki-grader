...
$expectedArchiveSha256 = '9aead700498dadc5c030ab205dec92c876c9add6365837d7ce6793dacad2182c'
...
if ([string] $installation.version -eq '0.9.7') {
    Write-Host 'Ooki Grader is already at version 0.9.7.'
