...
$expectedArchiveSha256 = 'd6681fd1dc435291a558e3244ac8023ca5ba97b7a67f0100387a553e82131bd9'
...
if ([string] $installation.version -eq '0.9.9') {
    Write-Host 'Ooki Grader is already at version 0.9.9.'
