...
$expectedArchiveSha256 = '1e05229ffd8d34769000f379524a2f8f7c89f6bb85e959fb339d3e47564e9a79'
...
if ([string] $installation.version -eq '0.9.5') {
    Write-Host 'Ooki Grader is already at version 0.9.5.'
