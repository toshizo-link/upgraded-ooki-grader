...
$expectedArchiveSha256 = '0f0a44a0f036bb03ef4ad027254111a10f50161e60066946de0b7f1bb27004e4'
...
if ([string] $installation.version -eq '0.9.13') {
    Write-Host 'Ooki Grader is already at version 0.9.13.'
