...
$expectedArchiveSha256 = '9735f800556be8f2a227e184e65f239da62d856047e8e326619ff7c5e216ff7e'
...
if ([string] $installation.version -eq '0.9.6') {
    Write-Host 'Ooki Grader is already at version 0.9.6.'
...
Write-Host '  Safety:          verified backup and prior version retained'
Write-Host ''
