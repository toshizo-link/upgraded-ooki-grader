...
$expectedArchiveSha256 = '07173fdef6efd33b8865bdd83467f5963b7029d454bc54f3e2d63a0bd879a1be'
...
if ([string] $installation.version -eq '0.9.8') {
    Write-Host 'Ooki Grader is already at version 0.9.8.'
