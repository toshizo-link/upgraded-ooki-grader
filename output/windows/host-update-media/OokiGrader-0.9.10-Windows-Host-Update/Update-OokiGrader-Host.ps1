...
$expectedArchiveSha256 = '3dfe1885904c7b403d19b7d81782ba14fe1c911da7ceb8df78a0075df0772ce4'
...
if ([string] $installation.version -eq '0.9.10') {
    Write-Host 'Ooki Grader is already at version 0.9.10.'
